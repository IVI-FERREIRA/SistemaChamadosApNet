...
): array
{
    ...
    if ($isDigital !== null) {
        ...
        $terms.= (strlen($terms) ? " AND cat.cat_is_digital = {$isDigital} AND " : " cat.cat_is_digital = {$isDigital} AND ");
    }

    if ($isProduct !== null) {

        $isProduct = ($isProduct == true || $isProduct == 1 ? 1 : 0);
        $terms.= (strlen($terms) ? " AND cat.cat_is_product = {$isProduct} AND " : " cat.cat_is_product = {$isProduct} AND ");
    }
