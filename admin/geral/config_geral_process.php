...
// $data['closing_mode'] = (isset($post['closing_mode_requester']) ? ($post['closing_mode_requester'] == "yes" ? 2 : 1) : 1);
$data['status_done'] = (isset($post['status_done']) ? (int)$post['status_done'] : 4);
$data['status_done_rejected'] = (isset($post['status_done_rejected']) ? (int)$post['status_done_rejected'] : 1);
$data['time_to_close_after_done'] = (isset($post['time_to_close_after_done']) && ($post['time_to_close_after_done'] > 0) ? (int)$post['time_to_close_after_done'] : 3);
